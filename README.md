...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 978b90cc-5e6c-4191-9621-d2bc8c0d3d83
```

> `978b90cc-5e6c-4191-9621-d2bc8c0d3d83` is the password of the certificate, you can change it to any password you want.
